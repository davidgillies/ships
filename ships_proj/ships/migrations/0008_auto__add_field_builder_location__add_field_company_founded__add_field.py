...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Builder.location'
        db.add_column(u'ships_builder', 'location',
    ...
    def backwards(self, orm):
        # Deleting field 'Builder.location'
        db.delete_column(u'ships_builder', 'location')
    ...
    models = {
        u'ships.builder': {
            ...
            'nationality': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'})
        },
        u'ships.company': {
